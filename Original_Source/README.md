...
```
cd existing_repo
git remote add origin https://gitlab.rz.htw-berlin.de/annusch/rpdac-midog.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.rz.htw-berlin.de/annusch/rpdac-midog/-/settings/integrations)
